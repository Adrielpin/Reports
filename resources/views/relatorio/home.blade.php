...
<script type="text/javascript">
	...
	function Go(){
		...
		var result = $.get(url, {'id':id, 'type': tipo, 'periodos': periodos}, function (response){
			...
			(typeof hourCliques != 'undefined') ? (hourCliques.setDataTable(response[10]), hourCliques.draw()) : hourCliques = null;
			(typeof hourImpressoes != 'undefined') ? (hourImpressoes.setDataTable(response[11]), hourImpressoes.draw()) : hourImpressoes = null;
			(typeof hourCpc != 'undefined') ? (hourCpc.setDataTable(response[12]), hourCpc.draw()) : hourCpc = null;
			(typeof hourInvestimento != 'undefined') ? (hourInvestimento.setDataTable(response[13]), hourInvestimento.draw()) : hourInvestimento = null;
			(typeof hourCtr != 'undefined') ? (hourCtr.setDataTable(response[14]), hourCtr.draw()) : hourCtr = null;
			(typeof hourPosicao != 'undefined') ? (hourPosicao.setDataTable(response[15]), hourPosicao.draw()) : hourPosicao = null;
			(typeof hourConversao != 'undefined') ? (hourConversao.setDataTable(response[16]), hourConversao.draw()) : hourConversao = null;
			(typeof hourCustoConversao != 'undefined') ? (hourCustoConversao.setDataTable(response[17]), hourCustoConversao.draw()) : hourCustoConversao = null;
			(typeof hourTaxaConversao != 'undefined') ? (hourTaxaConversao.setDataTable(response[18]), hourTaxaConversao.draw()) : hourTaxaConversao = null;
